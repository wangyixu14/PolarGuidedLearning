...
NN_HOME = ./
LIB_HOME = ./POLAR
LIBS = -lflowstar -lmpfr -lgmp -lgsl -lgslcblas -lm -lglpk -lcnpy -lz
...
all: benchmark6_relu_tanh benchmark5_relu_tanh benchmark_oscillator_relu_tanh
...
benchmark_oscillator_relu_tanh: systems/reachnn_oscillator_relu_tanh.o $(OBJS)
	g++-8 -O3 -w $(LINK_FLAGS) -o $@ $^ $(LIBS)
